...
path_input_images = "/work/vajira/DATA/Hecktor_2022/original_data/hecktor2022_testing/imagesTs"
#path_input_labels = "/work/vajira/DATA/Hecktor_2022/original_data/hecktor2022_training/hecktor2022/labelsTr"
path_output_images = "/work/vajira/DATA/Hecktor_2022/resampled_data/testing/imagesTs"
#path_output_labels = "/work/vajira/DATA/Hecktor_2022/resampled_data/training/labelsTr"
...
def main(input_image_folder, output_image_folder,
          cores, resampling):
    ...
    def resample_one_patient(p):
        ...
        #print(list(input_label_folder.glob(p + "*")))        
